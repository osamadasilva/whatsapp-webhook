...
module.exports = async function handler(req, res) {
  ...
  const isConfirmationQuestion = lastBotMessage.includes("هل نأكد") || lastBotMessage.includes("هل تأكد") || lastBotMessage.includes("نأكد؟") || lastBotMessage.includes("تأكد؟");
