...
راقب سياق المحادثة بعناية. إذا فهمت أن العميل يريد تأكيد الطلب —
قل بالضبط هذه الجملة فقط ولا تضيف أي شيء ولا تعرض الطلب مرة ثانية ولا تسأل مجدداً:
تم تأكيد طلبك 🌷

إذا لم تكن متأكداً من نية العميل، اسأل مرة واحدة فقط: "هل تأكد الطلب يا عزيزي؟ ✅"
لا تكرر سؤال التأكيد أكثر من مرة أبداً.
`;
